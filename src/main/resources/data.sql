...
INSERT INTO POPUST_KOD(KOD, POPUST, ISKORISTEN, KREIRAN) VALUES
...
INSERT INTO NARUDZBA(POPUST_KOD_ID, NACIN_PLACANJA_ID, UKUPNA_CIJENA_BEZ_POPUSTA, UKUPNA_CIJENA_S_POPUSTOM, DATUM, BROJ_KARTICE, EMAIL, BROJ_MOBITELA, ADRESA_DOSTAVE, NAPOMENA)
    VALUES(1, 1, 998.00, 798.40, current_timestamp, '5474765157064399', 'pgalina@foi.hr', '0951975552', 'Madžarevo 212a, 42220 Novi Marof', 'N/A');
...
INSERT INTO NARUDZBA_PROIZVOD(NARUDZBA_ID, PROIZVOD_ID) VALUES
    (1, 1),
    (1, 2);